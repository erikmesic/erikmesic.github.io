...
(function(){
  ...
  function controls(){
    ...
    style.textContent=`
      ...
      :root.light #erik-assistant .assistant-launch{background:var(--panel)!important;color:var(--text)!important;-webkit-text-fill-color:var(--text)!important;border-color:rgba(107,75,42,.45)!important}
      :root.light #erik-assistant .assistant-launch span{color:var(--accent-2)!important}
      ...
      #erik-assistant.open .assistant-launch span,#erik-assistant:has(.assistant-panel[aria-hidden="false"]) .assistant-launch span{transform:rotate(45deg)!important}

      @media(max-width:600px){
        #erik-assistant{right:12px!important;bottom:76px!important;left:auto!important;width:auto!important}
        #erik-assistant .assistant-panel{position:fixed!important;right:12px!important;bottom:76px!important;left:12px!important;width:auto!important;max-width:none!important;max-height:calc(100dvh - 100px)!important;overflow-x:hidden!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}
