...
(function(){
  ...
  function controls(){const style=document.getElementById('final-fixes-style')||document.createElement('style');style.id='final-fixes-style';style.textContent=`
      ...
      .gis-backpacking-map .trip-route{stroke:#8b5e3c;stroke-width:3.2;dash-array:none;opacity:.82}.gis-backpacking-map .map-heading{font-family:Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase;font-size:.72rem;color:#5c4b3a;margin:.75rem 0 .35rem;font-weight:700}.gis-backpacking-map .map-note{font-size:.8rem;color:#5c4b3a;margin:.55rem 0 0}.gis-backpacking-map .backpacking-map-caption{display:none!important}.gis-backpacking-map .leaflet-control-zoom a{color:#5c4b3a}.backpacking-map-caption{display:none!important}
